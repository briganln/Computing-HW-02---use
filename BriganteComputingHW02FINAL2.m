...
snapnow
figure, plot(Bleb_blur), title('Gaussian filter kernel plot (imgaussfilt)')
figure, imagesc(Bleb_blur), axis square, colormap turbo, title('Filter Kernel');
snapnow
figure
...
Bleb_blur2 = fspecial('gaussian')
figure, plot(Bleb_blur2), title('Gaussian filter kernel plot (fspecial)')
